...
def main():
    ...
    casa.add(TarefaRecorrente('Lavar o quintal', datetime.now(), 7))
    casa.add(casa.procurar('Lavar o quintal').concluir())
    print(casa)
    ...
    mercado.add('Frios')
    mercado.add('Pães', datetime.now() + timedelta(days=3, minutes=12))
